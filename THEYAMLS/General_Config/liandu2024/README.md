...
| 特性 | `clash-all-fallback.yaml` | `clash-fallback-all.yaml` | `clash-fallback-std.yaml` | `clash-fallback-dialer.yaml` | `clash-fallback.yaml` |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **大小** | 17.2 KB | 18.6 KB | 17.3 KB | 16.3 KB | 15.9 KB |
