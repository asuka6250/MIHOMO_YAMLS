...
| :--- | :--- | :--- | :--- | :--- |
| **大小** | 8.2 KB | 6.6 KB | 18.7 KB | 4.2 KB |
...
#### 📝 config.yaml
- **路径**: `ClashMix/config.yaml` | **大小**: 6.6 KB | [查看源码](https://github.com/HenryChiao/MIHOMO_YAMLS/blob/main/THEYAMLS/Mobile_Modules/ClashMix/config.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
